# Command: 
# CUDA_VISIBLE_DEVICES=1 python export_inference_graph.py --input_type image_tensor --pipeline_config_path training_320x240_ssdlitev2_8bit_sym2/ssd_mobilenet_v2_oid_v4.config --trained_checkpoint_prefix training_320x240_ssdlitev2_8bit_sym2/model.ckpt-113582 --output_directory trained-inference-graphs/output_inference_graph_320x240_ssdlitev2_8bit_sym2.pb
