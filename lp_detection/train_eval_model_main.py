...
# evaluation: CUDA_VISIBLE_DEVICES=1 python train_eval_model_main.py --pipeline_config_path=configs/ssd_mobilenet_v2_oid_v4.config --checkpoint_dir=./pre-trained/output_inference_graph_320x240_ssdlitev2_8bit_sym_fixdeptw.pb --run_once
