...
class train:
  ...
  file_list_path = '/home/lamberti/work_OCR/Dataset/CCPD_crops/train_ccpd_crops'
...
class eval:
  ...
  # file_list_path = '/home/lamberti/work_OCR/Dataset/synthetic_chinese_license_plates_LPRNet/val'
  file_list_path = '/home/lamberti/work_OCR/Dataset/CCPD_crops/valid_ccpd_crops'
  checkpoint = '/home/lamberti/work_OCR/2_steps_license_plates/lp_recognition/pretrained_model/LPRNet_CCPD_no_tile_64_quantized/model.ckpt-250000.ckpt'
  batch_size = 1
...
class infer:
  ...
  # file_list_path = '/home/lamberti/work_OCR/Dataset/synthetic_chinese_license_plates_LPRNet/crops' # Synthetic
  file_list_path = '/home/lamberti/work_OCR/Dataset/CCPD_crops/test_ccpd_crops' # CCPD

  checkpoint = '/home/lamberti/work_OCR/2_steps_license_plates/lp_recognition/pretrained_model/LPRNet_CCPD_no_tile_64_quantized/model.ckpt-250000.ckpt'
  batch_size = 1

  #Output path where prediction images are saved
  output_dir='/home/lamberti/work_OCR/output_debug/'
