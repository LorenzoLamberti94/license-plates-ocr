...
model_dir = os.path.realpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'model_ccpd_and_synth'))
...
class train:
  ...
  file_list_path = '/home/lamberti/work/Dataset/CCPD_crops/train_ccpd_and_synth_crops'
...
class eval:
  ...
  # file_list_path = '/home/lamberti/work/Dataset/synthetic_chinese_license_plates_LPRNet/val'
  #file_list_path = '/home/lamberti/work/Dataset/CCPD_crops/valid_ccpd_crops'
  file_list_path = '/home/lamberti/work/2_steps_license_plates/dataset/generated_crops_my_dataset_china/eval'

  checkpoint = '/home/lamberti/work/2_steps_license_plates/lp_recognition/pretrained_model/LPRNet_CCPD_and_synth_no_tile_64_quantized/model.ckpt-400000.ckpt'
  batch_size = 1
...
class infer:
  ...
  # file_list_path = '/home/lamberti/work/Dataset/synthetic_chinese_license_plates_LPRNet/crops' # Synthetic
  file_list_path = '/home/lamberti/work/Dataset/CCPD_crops/test_ccpd_crops' # CCPD
