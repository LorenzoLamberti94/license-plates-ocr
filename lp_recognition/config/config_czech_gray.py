...
class eval:
  ...
  # checkpoint = ''
  checkpoint = '/home/lamberti/work/2_steps_license_plates/lp_recognition/pretrained_model/LPRNet_EU_no_tile_grayscale/model.ckpt-250000.ckpt'
  batch_size = 1
...
class infer:
  ...
  checkpoint = '/home/lamberti/work/2_steps_license_plates/lp_recognition/pretrained_model/LPRNet_czech_no_tile_grayscale/model.ckpt-250000.ckpt'
  batch_size = 1
