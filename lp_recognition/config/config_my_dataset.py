...
class infer:
  # Path to the folder with all testing images
  file_list_path = '/home/lamberti/work/2_steps_license_plates/dataset/generated_crops_my_dataset/'
  checkpoint = '/home/lamberti/work/2_steps_license_plates/lp_recognition/pretrained_model/model.ckpt'
  batch_size = 1

  #Output path where prediction images are saved
  output_dir='/home/lamberti/work/2_steps_license_plates/dataset/text_recognition_my_dataset/'
